...
//   let result = [];
//   let dividedNum = num;
//   for (let i = 2; i <= dividedNum; i++) {
//     for (let j = 0; j < result.length; j++) {
//       if (dividedNum % result[j] === 0 ) {
//         dividedNum = dividedNum / result[j];
//       }
//     }
//     if (dividedNum % i === 0) {
...
//     }
//   }
//   console.log(`The factors of ${num} is: `, result);
//   return result;
// }

// primeFactors(1540);

const recPrimeFactors = (num, primeArray = []) => {
  let i = 2;
  while (i <= num) {
    if (num % i === 0) {
      primeArray.push(i);
