...
const bitwiseAND = (num1, num2) => {
  const bi1Array = num1.toString(2).split('').reverse();
  const bi2Array = num2.toString(2).split('').reverse();
  let resultArray = []
  let resultBi = 0;
  ...
  resultBi = parseInt( resultArray.reverse().join(''), 2 );
  return resultBi;
}

console.log(bitwiseAND(22, 27));
...
// ## Hints
//
// - [How to convert a decimal number into binary / a binary into decimal](https://gist.github.com/gcrk/a2401867ea8d1a9f5ecd44ced97a195e){:target="_blank"}
//
