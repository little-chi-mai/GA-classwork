...
# # Extensions
#
# Now compare your results with the Javascript version of your code (wednesday's warmup)
#
# ```javascript
# if ( javascript.results === ruby.results ) {
#   console.log("Error")
#   fixRubyCode()
# } else {
#   console.log("Good")
...
def grain (square)
  ...
  puts "Square #{square}: #{result[square]} grains."

  result.each do |squareNum, grainNum|
    puts "Square #{squareNum}: #{grainNum}."
  end

  puts "Total number of grains: #{result.values.reduce(0, :+)}"
end
